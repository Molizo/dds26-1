...
RECOVERY_SCAN_INTERVAL_SECONDS = int(os.environ.get("RECOVERY_SCAN_INTERVAL_SECONDS", "5"))
RECOVERY_LEADER_LOCK_TTL_SECONDS = int(os.environ.get("RECOVERY_LEADER_LOCK_TTL_SECONDS", "15"))
RECOVERY_BATCH_SIZE = int(os.environ.get("RECOVERY_BATCH_SIZE", "100"))
RECOVERY_STALE_TX_GRACE_SECONDS = int(
    os.environ.get(
        "RECOVERY_STALE_TX_GRACE_SECONDS",
        str(max(45, ORDER_LOCK_TTL_SECONDS * 2)),
    )
)
RECOVERY_LEADER_LOCK_KEY = os.environ.get(
    "RECOVERY_LEADER_LOCK_KEY",
    "checkout_recovery_leader_lock",
)
REQUEST_HEALING_BUDGET_SECONDS = int(os.environ.get("REQUEST_HEALING_BUDGET_SECONDS", "30"))
REQUEST_HEALING_RETRY_INTERVAL_SECONDS = float(
    os.environ.get("REQUEST_HEALING_RETRY_INTERVAL_SECONDS", "0.5")
)
